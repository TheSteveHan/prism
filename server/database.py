...
class Post(db.Model):
    ...
    e_score = db.Column(db.Float, nullable=True, default=None)
    e_conf = db.Column(db.Float, nullable=True, default=None)
    i_score = db.Column(db.Float, nullable=True, default=None)
    i_conf = db.Column(db.Float, nullable=True, default=None)
    a_score = db.Column(db.Float, nullable=True, default=None)
